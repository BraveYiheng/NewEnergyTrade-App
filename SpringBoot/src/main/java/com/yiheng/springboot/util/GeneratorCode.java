...
public class GeneratorCode {
    private static final String AUTHOR="Chu";
    private static final String
            JDBC_URL="jdbc:mysql://127.0.0.1:3306/stu_sys";
    private static final String JDBC_USERNAME="root";
    private static final String JDBC_PASSWORD="123456";
    private static final String OUT_DIR=".\\src\\main\\java";
    private static final String PACKAGE_NAME="com.chu";
    // private static final String MODULE_NAME="rental";
    private static final String[] TABLES={
            "comment","document","favorite","follow","knowledge_category",
            "knowledge_content","personal_info","points_rule","role","user"
    };       
